...
class ConductorAPI(object):
    ...
    def deployable_program(self, context, obj_dep, firmware_uuid):
        """Signal to conductor service to get a list of deployables.
        :param context: request context.
        :param obj_dep: a deployable object to delete.
        :param firmware_uuid: the uuid of glance image.
        :returns: firmware program result
        """
        cctxt = self.client.prepare(topic=self.topic)
        return cctxt.call(context, 'deployable_program', obj_dep=obj_dep, firmware_uuid=firmware_uuid)
