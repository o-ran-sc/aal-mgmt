...
class Deployable(base.CyborgObject, object_base.VersionedObjectDictCompat):
    ...
    fields = {
        ...
        'function': object_fields.StringField(nullable=True),
        ...
        'availability': object_fields.EnumField(
            ['free', 'in-use', 'in-programing', 'error'], nullable=False),
        ...
        'programable': object_fields.BooleanField(nullable=False),
        # identify if this device can be program like FPGA.
